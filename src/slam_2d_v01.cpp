...
void MapBuilder::SetMapParameter()
{
    ...
    MapParameter_.miniUpdatedDT = 0.15;
    MapParameter_.miniUpdateDR = 0.05;
...
MapBuilder::LaserData & MapBuilder::VoxelFilter(const MapBuilder::LaserData& Laser_data_, double pixelSize)
{
    ...
    V02_keyscan_pool.push_back(vector<Array2d>());
    vector<Array2d>& filtered_pointCloud = V02_keyscan_pool.back();
    filtered_pointCloud.reserve(500);
    int count = 1;
...
// AddKeyScan for V02  Ϊ��ģ��Cartographer��״̬������submap��node�Ĳ���
