...
public:
    ...
    void GenerateSearchWindow_BBM(const LaserFan & laserfan_, double linear_window, double rotation_window, double pixelSize_);
    vector<CSM::DiscreteRotatedResult> GenerateRotationDiscreteScans_BBM(const LaserData& laserdata_, Array3d pose_guess_);
    ...
    CSM::MatchResult_BBM BranchAndBoundMatch(M2MPGM& m2mpgm_, const LaserData& laserdata_, const Array3d& pose_gues);
    ...
    CSM::MatchResult_BBM BranchAndBoundLoop(M2MPGM& m2mpgm, int height,
    ...
    const SearchWindowParameter& GetWindowParameter() const{ return SearchWindowParameter_; }
